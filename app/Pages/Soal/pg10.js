...
const PilihanGanda = () => {
  ...
  const soal = [
    {
      id: "1",
      Soal: `Kelompok A adalah kelompok mahasiswa yang mengambil mata kuliah Logika 
Kelompok B adalah kelompok mahasiswa yang mengambil mata kuliah Matematika Diskrit. 

Manakah operasi logika yang ekuivalen dengan gabungan antara kelompok A dengan Kelompok B?`,
      pilihan: [
        { id: "a", text: "A AND B", correct: true},
        { id: "b", text: "A OR B", correct: false },
        { id: "c", text: "NOT A", correct: false},
        { id: "d", text: "NOT B", correct: false },
      ],
    },
  ];
