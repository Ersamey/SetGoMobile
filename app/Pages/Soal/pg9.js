...
const PilihanGanda = () => {
  ...
  const soal = [
    {
      id: "3",
      Soal: "Pada operasi logika XOR, kapan output akan bernilai true",
      pilihan: [
        { id: "a", text: " Jika salah satu input bernilai true, tetapi tidak keduanya", correct: true},
        { id: "b", text: "Jika kedua input bernilai true", correct: false },
        { id: "c", text: " Jika kedua input bernilai false", correct: false},
