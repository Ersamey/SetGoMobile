  ...
  const soal = [
    {
      ...
      pilihan: [
        { id: "a", text: "Mengolah data numerik menjadi grafik visual", correct: false},
        { id: "b", text: "Mengubah satu atau beberapa masukan menjadi suatu sinyal output (keluaran) yang bersifat logis berdasarkan sistem bilangan biner yaitu 0 dan 1", correct: true },
        { id: "c", text: "Menyimpan data dalam sistem digital untuk penggunaan di masa mendatang", correct: false},
        { id: "d", text: "Menerjemahkan data analog menjadi data digital secara otomatis", correct: false },
      ],
    },
  ];
