...
const PilihanGanda = () => {
  ...
  const soal = [
    {
      id: "3",
      Soal: `Terdapat 2 himpunan.
Himpunan A merupakan himpunan siswa yang lulus ujian matematika sedangkan himpunan B merupakan himpunan siswa yang lulus ujian IPA. 
Jika gerbang logika yaitu A AND B diaplikasikan, maka daerah yang direpresentasikan pada diagram Venn adalah?`,
      pilihan: [
        { id: "a", text: "Seluruh daerah dalam A U B", correct: false },
        { id: "b", text: "Daerah A n B saja", correct: true },
        { id: "c", text: "Daerah A n komplemen B", correct: false },
        { id: "d", text: "Seluruh daerah kecuali A n B", correct: false },
      ],
    },
  ];
